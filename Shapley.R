...
for (j in 4:22){
for (k in (j+1):23){
a <- c(ifelse(i!=1,2,1),ifelse(i!=2,2,1),ifelse(i!=3,2,1),ifelse(j==4,2,1),
ifelse((j==5)|(k==5),2,1),ifelse((j==6)|(k==6),2,1),ifelse((j==7)|(k==7),2,1),
ifelse((j==8)|(k==8),2,1),ifelse((j==9)|(k==9),2,1),ifelse((j==10)|(k==10),2,1),
ifelse((j==11)|(k==11),2,1),ifelse((j==12)|(k==12),2,1),ifelse((j==13)|(k==13),2,1),
ifelse((j==14)|(k==14),2,1),ifelse((j==15)|(k==15),2,1),ifelse((j==16)|(k==16),2,1),
ifelse((j==17)|(k==17),2,1),ifelse((j==18)|(k==18),2,1),ifelse((j==19)|(k==19),2,1),
ifelse((j==20)|(k==20),2,1),ifelse((j==21)|(k==21),2,1),ifelse((j==22)|(k==22),2,1),
ifelse(k==23,2,1))
v[a[1]:2,a[2]:2,a[3]:2,a[4]:2,a[5]:2,a[6]:2,a[7]:2,a[8]:2,a[9]:2,a[10]:2,a[11]:2,
a[12]:2,a[13]:2,a[14]:2,a[15]:2,a[16]:2,a[17]:2,a[18]:2,a[19]:2,a[20]:2,a[21]:2,
a[22]:2,a[23]:2] <- 1}}}
s <- shapley.value(v)
s
sum(s[1:3])
